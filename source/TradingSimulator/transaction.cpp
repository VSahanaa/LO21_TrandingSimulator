...
void TransactionManager::addTransaction(Qdate date,const PaireDevises *paire, CoursOHLCV *cours, bool achat, double montant) {
    ...
    listeTransaction = new Transaction(date,listeTransaction, paire, cours, achat, montantBase, montantContrepartie);    //effectuer la transaction
}

void TransactionManager::addTransaction(Qdate date,const PaireDevises *paire, CoursOHLCV *cours, bool achat, double montantBase, double montantContrepartie) {
    listeTransaction = new Transaction(date,listeTransaction, paire, cours, achat, montantBase, montantContrepartie);
}
