...
public:
	...
	*/
    QString forme() const;
	//! méthode isBigBlackCandle
	/** 
	* \return  bool : true si la bougie est noir, false sinon
    */
	bool isBigBlackCandle() const;
	//! méthode isBigWhiteCandle
	/** 
	* \return  bool : true si la bougie est blanche, false sinon
    */
	bool isBigWhiteCandle() const;
	//! méthode isSpinningTop
	/** 
