...
class Transaction {
    ...
    Transaction(Qdate date,Transaction* transactionDernier, const PaireDevises* paire, CoursOHLCV* cours, bool achat, double montantBase, double montantContrepartie):
        Qdate(date),transactionDernier(transactionDernier), paire(paire), cours(cours), achat(achat), montantBase(montantBase), montantContrepartie(montantContrepartie) {}
public:
...
public:
    void addTransaction(Qdate date,const PaireDevises* paire, CoursOHLCV* cours, bool achat, double montant);
    void addTransaction(Qdate date,const PaireDevises* paire, CoursOHLCV* cours, bool achat, double montantBase, double montantContrepartie);
